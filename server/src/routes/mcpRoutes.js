...
mcpRoutes.get("/health", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool health", details: error.message });
  }
});
...
mcpRoutes.get("/auth_status", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool auth_status", details: error.message });
  }
});
...
mcpRoutes.get("/list_jobs", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool list_jobs", details: error.message });
  }
});
...
mcpRoutes.post("/sync_jobs", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool sync_jobs", details: error.message });
  }
});
...
mcpRoutes.post("/create_job", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool create_job", details: error.message });
  }
});
...
mcpRoutes.patch("/update_job", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool update_job", details: error.message });
  }
});
...
mcpRoutes.delete("/delete_job", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool delete_job", details: error.message });
  }
});
...
mcpRoutes.get("/template_list", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to run MCP tool template_list", details: error.message });
  }
});
