...
resumeRoutes.post("/upload", upload.single("file"), async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to upload resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.get("/", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to fetch resumes", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.get("/:id/download", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to download resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.get("/:id/view", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to view resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.get("/:id/preview", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to fetch resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.patch("/:id", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to update resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.delete("/:id", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to delete resume", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
resumeRoutes.get("/:id/versions", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to fetch versions", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
