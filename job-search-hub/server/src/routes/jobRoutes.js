...
jobRoutes.get("/", requireUserAuth, async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Unable to load jobs", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/sync", requireUserAuth, requireTierGmailSync, rateLimitMiddleware, async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Sync failed", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/backfill-emails", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Backfill failed", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/", async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Unable to create job", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/analytics/weekly", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to build weekly analytics", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/analytics/daily", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to build daily analytics", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/daily-report", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to build daily report", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/export/csv", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to export CSV", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/timeline/:id", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to load timeline", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/notifications/hooks/due-reminders", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to send notification hooks", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.patch("/:id", async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Unable to update job", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.delete("/:id", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Unable to delete job", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/:id/imported", async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Unable to mark imported", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.get("/:id/emails", async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Unable to load job emails", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
...
jobRoutes.post("/:id/emails", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({ error: "Unable to add job email", ...(process.env.NODE_ENV !== "production" && { details: error.message }) });
  }
});
